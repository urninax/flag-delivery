...
public interface FlagsRepositoryCustom{
    List<FeatureFlag> findAllWithFilter(UUID projectId, ListAllFlagsRequest request, Sort sort);
    Page<FeatureFlag> findPageWithFilter(UUID projectId, ListAllFlagsRequest request, Pageable pageable);
}
