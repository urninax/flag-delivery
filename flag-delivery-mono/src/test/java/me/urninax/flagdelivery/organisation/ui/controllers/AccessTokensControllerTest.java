...
public class AccessTokensControllerTest {
    ...
    class CreateAccessTokenCases {
        ...
        void createAccessToken_withValidRequest_shouldReturn201() throws Exception {
            when(accessTokenService.issueToken(any())).thenReturn("api-abc-123");
            ...
            verify(accessTokenService, times(1)).issueToken(any());
        }
    ...
    class GetAccessTokensCases {
        ...
        void getAccessTokens_shouldReturnPage() throws Exception {
            ...
            when(accessTokenService.getTokensForUserInOrg(any(), any())).thenReturn(page);
            ...
            mockMvc.perform(get("/api/v1/organisation/access-tokens")
                    ...
                    .andExpect(jsonPath("$.content[0].hint").value("abc123"));

            verify(accessTokenService, times(1)).getTokensForUserInOrg(any(), any());
        }
    }
}
