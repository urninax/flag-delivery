...
//    @Test
//    @DisplayName("As ADMIN -> change WRITER role to READER -> 200")
//    void changeRole_asAdminChangeWriterToReader_shouldReturn200(){
...
//                .expectStatus().isOk();
//
//        OrgRole updatedRole = helper.getUserRoleInOrganisation(writerId, organisationId);
//        assertEquals(OrgRole.READER, updatedRole, "User's role should have been updated to READER");
//    }
//
//    @Test
//    @DisplayName("As ADMIN -> change to the same role (idempotent) -> 200 and no side effects")
//    void changeRole_asAdminChangeToSameRole_shouldReturn200WithoutChange(){
...
//
//        OrgRole updatedRole = helper.getUserRoleInOrganisation(writerId, organisationId);
//        assertEquals(OrgRole.WRITER, updatedRole, "Role should remain unchanged.");
//    }
//
//    @Test
//    @DisplayName("As ADMIN -> try to change own role -> 400")
//    void changeRole_asAdminChangeOwnRole_shouldReturn400(){
//        ChangeMembersRoleRequest request = new ChangeMembersRoleRequest(OrgRole.WRITER);
//
//        client.patch()
//                .uri("/api/v1/organisation/members/{uuid}", adminId)
//                .header(HttpHeaders.AUTHORIZATION, adminToken)
//                .bodyValue(request)
//                .exchange()
//                .expectStatus().isBadRequest();
//
//        OrgRole updatedRole = helper.getUserRoleInOrganisation(adminId, organisationId);
//        assertEquals(OrgRole.WRITER, updatedRole, "Role should remain unchanged.");
//    }
//
//    @Test
//    @DisplayName("As ADMIN -> try to change OWNER role -> 403")
//    void changeRole_asAdminChangeOwnerRole_shouldReturn403(){
//        ChangeMembersRoleRequest request = new ChangeMembersRoleRequest(OrgRole.WRITER);
//
//        client.patch()
//                .uri("/api/v1/organisation/members/{uuid}", ownerId)
//                .header(HttpHeaders.AUTHORIZATION, adminToken)
//                .bodyValue(request)
//                .exchange()
